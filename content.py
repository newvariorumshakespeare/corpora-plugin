...
REGISTRY = [
    ...
    },
    {
        ...
        "templates": {
            "Label": {
                "template": "{{ Document.siglum_label|safe|striptags }}",
                "mime_type": "text/html"
            }
        },
        "inherited": True,
    ...
    },
{
    ...
    },
    {
        ...
        "fields": [
            ...
            {
                "name": "collation_status",
                "label": "Collation Status",
                "indexed": False,
                "unique": False,
                "multiple": False,
                "in_lists": True,
    ...
    },
    {
        ...
        "templates": {
            "Label": {
                "template": "{% if CollationLine.play %}{{ CollationLine.play.prefix }} {% endif %}{{ CollationLine.tln }}",
                "mime_type": "text/html"
            }
        },
        "view_widget_url": None,
